...
public class SellerServiceImpl implements SellerService{
  ...
  private final AddressRepository addressrepository;
    ...
    public Seller createSeller(Seller seller) throws SellerAlreadyExistsException   {
        ...
        if(sellerExist!=null){
            throw new SellerAlreadyExistsException("Seller already Exist, used Different email");
    ...
    public Seller getSellerById(Long id) throws SellerException  {
       ...
       .orElseThrow(()-> new SellerException("Seller Not Found the ID :: "+ id));
    }
    ...
    @Override
    public Seller updatSeller(Long id, Seller seller) throws SellerException {
